...
async def procesar_datos(data: InputData):
    ...
    def cargar_datos(carrera, semestre):
        ...
        datos['DEPARTAMENTO']=datos['DEPARTAMENTO'].astype(int)
        datos['LOCALIDAD']=datos['LOCALIDAD'].astype(int)
        datos['INSCRIPCION']=datos['INSCRIPCION'].astype(int)
        datos['MUNICIPIO']=datos['MUNICIPIO'].astype(int)
        ...
        datos['MUNICIPIO']= np.where((datos['MUNICIPIO']>226),'NO REGISTRA',datos['MUNICIPIO'])
        return datos
