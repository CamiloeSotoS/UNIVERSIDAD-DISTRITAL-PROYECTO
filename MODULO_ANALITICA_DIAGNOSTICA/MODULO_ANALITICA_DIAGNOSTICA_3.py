...
async def procesar_datos(data: InputData):
    ...
    def cargar_datos(carrera, semestre):
        ...
        datos['LOCALIDAD_COLEGIO'] = datos['LOCALIDAD_COLEGIO'].replace({0:'NO REGISTRA', 1:'USAQUEN', 2:'CHAPINERO', 3:'SANTA FE', 3:'SANTAFE', 4:'SAN CRISTOBAL', 5:'USME', 6:'TUNJUELITO', 7:'BOSA', 0:'KENNEDY', 9:'FONTIBON', 10:'ENGATIVA',11: 'SUBA',12: 'BARRIOS UNIDOS', 13:'TEUSAQUILLO',14: 'LOS MARTIRES',15: 'ANTONIO NARINO', 16:'PUENTE ARANDA', 17: 'LA CANDELARIA', 18:'RAFAEL URIBE URIBE', 18:'RAFAEL URIBE', 19:'CIUDAD BOLIVAR', 20:'FUERA DE BOGOTA', 20:'SIN LOCALIDAD', 21:'SOACHA'})
