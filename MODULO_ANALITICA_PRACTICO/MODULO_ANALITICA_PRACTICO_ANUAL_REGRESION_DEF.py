...
variables_por_carrera = { 
    'industrial': {
        '1': ['PG_ICFES','CON_MAT_ICFES','FISICA_ICFES','QUIMICA_ICFES','IDIOMA_ICFES','RENDIMIENTO_UNO','PROMEDIO_UNO','LOCALIDAD_COLEGIO','BIOLOGIA_ICFES',
        ...
        '2': ['PG_ICFES', 'CON_MAT_ICFES', 'FISICA_ICFES','QUIMICA_ICFES','IDIOMA_ICFES','LOCALIDAD','RENDIMIENTO_UNO', 'PROMEDIO_UNO', 'LOCALIDAD_COLEGIO', 
              ...
              'RENDIMIENTO_DOS', 'PROMEDIO_DOS','NCC_DOS', 'NCA_DOS', 'NAA_DOS', 'NOTA_ALGEBRA', 'NOTA_INTEGRAL', 'NOTA_MATERIALES', 'NOTA_PBASICA', 'NOTA_EE_DOS', 'RENDIMIENTO_TRES', 
        ...
        '3': ['PG_ICFES', 'CON_MAT_ICFES', 'FISICA_ICFES','QUIMICA_ICFES','IDIOMA_ICFES','LOCALIDAD','RENDIMIENTO_UNO', 'PROMEDIO_UNO', 'LOCALIDAD_COLEGIO', 'BIOLOGIA_ICFES', 'CAR_UNO', 
              'NCC_UNO', 'NAA_UNO', 'NOTA_DIFERENCIAL', 'NOTA_DIBUJO', 'NOTA_QUIMICA', 'NOTA_CFJC', 'NOTA_TEXTOS', 'NOTA_SEMINARIO', 'NOTA_EE_UNO','RENDIMIENTO_DOS', 'PROMEDIO_DOS', 'NCC_DOS', 
              'NCA_DOS', 'NAA_DOS', 'NOTA_ALGEBRA', 'NOTA_INTEGRAL', 'NOTA_MATERIALES', 'NOTA_PBASICA', 'NOTA_EE_DOS', 'RENDIMIENTO_TRES', 'PROMEDIO_TRES', 'NAA_TRES', 'NOTA_MULTIVARIADO', 'NOTA_ESTADISTICA_UNO', 
              'NOTA_TERMODINAMICA', 'NOTA_TGS', 'NOTA_EE_TRES','RENDIMIENTO_CUATRO', 'PROMEDIO_CUATRO', 'NOTA_ECUACIONES', 'NOTA_ESTADISTICA_DOS', 'NOTA_FISICA_DOS', 'NOTA_MECANICA', 'NOTA_PROCESOSQ', 'RENDIMIENTO_CINCO', 
              'PROMEDIO_CINCO', 'NOTA_EE_CUATRO', 'NOTA_PROCESOSM', 'NOTA_ADMINISTRACION', 'NOTA_LENGUA_UNO', 'NOTA_EI_UNO', 'NOTA_EI_DOS', 'RENDIMIENTO_SEIS', 'PROMEDIO_SEIS', 'NCA_SEIS', 'NOTA_PLINEAL', 'NOTA_DISENO', 
              'NOTA_EI_TRES','RENDIMIENTO_SIETE', 'PROMEDIO_SIETE', 'NOTA_IECONOMICA', 'NAA_SIETE', 'NOTA_GRAFOS', 'NOTA_CALIDAD_UNO', 'NOTA_ERGONOMIA', 'NOTA_EI_CINCO','PROMEDIO_OCHO','PROMEDIO_NUEVE']
    },
    'sistemas': {
        '1': ['CON_MAT_ICFES','IDIOMA_ICFES','LOCALIDAD_COLEGIO','BIOLOGIA_ICFES','QUIMICA_ICFES','PG_ICFES','LITERATURA_ICFES','RENDIMIENTO_UNO',
              ...
              'NOTA_CATEDRA_CON','VECES_EE_UNO','RENDIMIENTO_DOS','PROMEDIO_TRES'],
        
        '2': ['CON_MAT_ICFES','IDIOMA_ICFES','LOCALIDAD_COLEGIO','BIOLOGIA_ICFES','QUIMICA_ICFES','PG_ICFES','LITERATURA_ICFES','RENDIMIENTO_UNO',
              'PROMEDIO_UNO','NOTA_DIFERENCIAL','NOTA_CATEDRA_DEM','NOTA_PROG_BASICA','NAA_UNO','CAR_UNO','NOTA_TEXTOS','NOTA_LOGICA','NOTA_SEMINARIO',
              'VECES_LOGICA','NAC_UNO','NCC_UNO','NCA_UNO','VECES_CATEDRA_DEM','NOTA_EE_UNO','NAP_UNO','VECES_DIFERENCIAL',
              'NOTA_CATEDRA_CON','VECES_EE_UNO','RENDIMIENTO_DOS','RENDIMIENTO_TRES','PROMEDIO_DOS','NOTA_TGS','NOTA_PROG_AVANZADA','NOTA_FISICA_DOS','NOTA_MULTIVARIADO',
              ...
              'NOTA_FUND_BASES','NAC_TRES','RENDIMIENTO_CUATRO','PROMEDIO_CINCO'],

        '3': ['CON_MAT_ICFES','IDIOMA_ICFES','LOCALIDAD_COLEGIO','BIOLOGIA_ICFES','QUIMICA_ICFES','PG_ICFES','LITERATURA_ICFES','RENDIMIENTO_UNO',
              'PROMEDIO_UNO','NOTA_DIFERENCIAL','NOTA_CATEDRA_DEM','NOTA_PROG_BASICA','NAA_UNO','CAR_UNO','NOTA_TEXTOS','NOTA_LOGICA','NOTA_SEMINARIO',
              'VECES_LOGICA','NAC_UNO','NCC_UNO','NCA_UNO','VECES_CATEDRA_DEM','NOTA_EE_UNO','NAP_UNO','VECES_DIFERENCIAL',
              'NOTA_CATEDRA_CON','VECES_EE_UNO','RENDIMIENTO_DOS','RENDIMIENTO_TRES','PROMEDIO_DOS','NOTA_TGS','NOTA_PROG_AVANZADA','NOTA_FISICA_DOS',
              ...
              'VECES_HOMBRE','NCC_TRES','NAA_TRES','NOTA_FUND_BASES','NAC_TRES','RENDIMIENTO_CUATRO','RENDIMIENTO_CINCO','PROMEDIO_TRES','NOTA_PROB','NOTA_CIENCIAS_COMP_UNO',
              ...
              'NOTA_CIENCIAS_COMP_DOS','VECES_REDES_COM_UNO','VECES_GI_UNO','VECES_ESTADISTICA','VECES_CIENCIAS_COMP_DOS','VECES_INV_OP_DOS','CAR_CINCO','RENDIMIENTO_SEIS',
              ...
              'VECES_F_ING_SOF','VECES_REDES_COM_DOS','VECES_EI_DOS','VECES_CIBERNETICA_DOS','NCP_SEIS','NOTA_GI_DOS','RENDIMIENTO_SIETE','PROMEDIO_SEIS','NOTA_DIS_ARQ_SOFT','NOTA_EI_OP_AI',
              ...
              'VECES_CIBERNETICA_TRES','RENDIMIENTO_OCHO','PROMEDIO_NUEVE']  
    },
    'catastral': {
        '1': ['CON_MAT_ICFES','IDIOMA_ICFES','BIOLOGIA_ICFES','GENERO','FILOSOFIA_ICFES','LOCALIDAD','LITERATURA_ICFES','QUIMICA_ICFES','PG_ICFES','RENDIMIENTO_UNO',
              ...
              'NOTA_DIF','NAP_UNO','VECES_HIST','VECES_ALGEBRA','NCP_UNO','RENDIMIENTO_DOS','PROMEDIO_TRES'],

        '2': ["CON_MAT_ICFES","IDIOMA_ICFES","BIOLOGIA_ICFES","GENERO","FILOSOFIA_ICFES","LOCALIDAD","LITERATURA_ICFES","QUIMICA_ICFES","PG_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO",
              "NOTA_ALGEBRA","NOTA_DITO","NOTA_TEXTOS","NOTA_CD&C","NCA_UNO","NAA_UNO","NOTA_HIST","NOTA_SEM","NOTA_DIF","NAP_UNO","VECES_HIST","VECES_ALGEBRA","NCP_UNO","RENDIMIENTO_DOS",
              "RENDIMIENTO_TRES","PROMEDIO_DOS","EPA_DOS","NOTA_TOP","NOTA_PROGB","NOTA_FIS_UNO","NOTA_INT","VECES_TOP","NOTA_EYB","PROMEDIO_TRES","NOTA_SUELOS","NOTA_POO","NOTA_FIS_DOS",
              "NOTA_ECUA","NCA_TRES","NOTA_FOTO","NOTA_CFJC","VECES_SUELOS","RENDIMIENTO_CUATRO","PROMEDIO_CINCO"],
        
        '3': ["CON_MAT_ICFES","IDIOMA_ICFES","BIOLOGIA_ICFES","GENERO","FILOSOFIA_ICFES","LOCALIDAD","LITERATURA_ICFES","QUIMICA_ICFES","PG_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO",
              "NOTA_ALGEBRA","NOTA_DITO","NOTA_TEXTOS","NOTA_CD&C","NCA_UNO","NAA_UNO","NOTA_HIST","NOTA_SEM","NOTA_DIF","NAP_UNO","VECES_HIST","VECES_ALGEBRA","NCP_UNO","RENDIMIENTO_DOS",
              "RENDIMIENTO_TRES","PROMEDIO_DOS","EPA_DOS","NOTA_TOP","NOTA_PROGB","NOTA_FIS_UNO","NOTA_INT","VECES_TOP","NOTA_EYB","PROMEDIO_TRES","NOTA_SUELOS","NOTA_POO","NOTA_FIS_DOS",
              "NOTA_ECUA","NCA_TRES","NOTA_FOTO","NOTA_CFJC","VECES_SUELOS","RENDIMIENTO_CUATRO","RENDIMIENTO_CINCO","PROMEDIO_CUATRO","NOTA_GEOGEO","NCA_CUATRO","NOTA_PRII","EPA_CUATRO",
              "NOTA_PROB","PROMEDIO_CINCO","NOTAS_SISC","VECES_BD","NOTA_ME","CAR_CINCO","NOTA_CARTO","VECES_CARTO","RENDIMIENTO_SEIS","PROMEDIO_SEIS","NOTA_GEO_FIS","NOTA_L_DOS","NOTA_LEGIC",
              "NOTA_INGECO","VECES_L_DOS","RENDIMIENTO_SIETE","PROMEDIO_SIETE","NOTA_ECONOMET","NOTA_AVAP","NOTA_EI_UNO","RENDIMIENTO_OCHO","PROMEDIO_NUEVE"],
    },
    'electrica':{
        '1': ['IDIOMA_ICFES','PG_ICFES','FISICA_ICFES','ANO_INGRESO','APT_VERB_ICFES','QUIMICA_ICFES','FILOSOFIA_ICFES','GENERO','BIOLOGIA_ICFES','RENDIMIENTO_UNO',
              'PROMEDIO_UNO','NOTA_POO','NOTA_INT','NOTA_FIS_DOS','NOTA_EYB','NOTA_DEM','NOTA_CIR_UNO','NOTA_HCI','VECES_INT','VECES_FIS_DOS','RENDIMIENTO_DOS','PROMEDIO_TRES'],

        '2': ["IDIOMA_ICFES","PG_ICFES","FISICA_ICFES","ANO_INGRESO","APT_VERB_ICFES","QUIMICA_ICFES","FILOSOFIA_ICFES","GENERO","BIOLOGIA_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO",
              "NOTA_POO","NOTA_INT","NOTA_FIS_DOS","NOTA_EYB","NOTA_DEM","NOTA_CIR_UNO","NOTA_HCI","VECES_INT","VECES_FIS_DOS","RENDIMIENTO_DOS","RENDIMIENTO_TRES","PROMEDIO_DOS",
              ...
              "NOTA_PYE","NOTA_ELD","VECES_ME","VECES_EL_DOS","NOTA_GEE","NOTA_CIR_TRES","VECES_PYE","RENDIMIENTO_CUATRO","PROMEDIO_CINCO"],   
        
        '3': ["IDIOMA_ICFES","PG_ICFES","FISICA_ICFES","ANO_INGRESO","APT_VERB_ICFES","QUIMICA_ICFES","FILOSOFIA_ICFES","GENERO","BIOLOGIA_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO","NOTA_POO",
              "NOTA_INT","NOTA_FIS_DOS","NOTA_EYB","NOTA_DEM","NOTA_CIR_UNO","NOTA_HCI","VECES_INT","VECES_FIS_DOS","RENDIMIENTO_DOS","RENDIMIENTO_TRES","PROMEDIO_DOS","NOTA_ECUA","NOTA_TERMO",
              ...
              "NOTA_GEE","NOTA_CIR_TRES","VECES_PYE","RENDIMIENTO_CUATRO","RENDIMIENTO_CINCO","PROMEDIO_CUATRO","NOTA_ASD","NOTA_CEM","NOTA_IO_UNO","NOTA_INSE","NOTA_IYM","NOTA_EE_UNO","NOTA_GENH","VECES_CEM",
              "VECES_IYM","VECES_INSE","NOTA_INGECO","NOTA_DDP","NOTA_CTRL","NOTA_CONEM","NOTA_TDE","VECES_INGECO","VECES_IO_DOS","VECES_DDP","NAC_CINCO","NOTAS_RDC","RENDIMIENTO_SEIS","VECES_ECO","NOTA_L_UNO",
              "NOTA_ASP","NOTA_ELECPOT","NOTA_ECO","NOTA_MAQEL","VECES_ASP","NOTA_AUTO","RENDIMIENTO_SIETE","PROMEDIO_SIETE","NOTA_FGEP","NOTA_HIST","NOTA_CCON","NOTA_L_DOS","NOTA_AIELEC","NOTA_SUBEL","VECES_SUBEL",
              "VECES_FGEP","VECES_L_DOS","VECES_HIST","RENDIMIENTO_OCHO","NOTA_L_TRES","NOTA_HSE","NOTA_ADMIN","NOTA_TGUNO","VECES_HSE","NOTA_EI_TRES","NOTA_EE_DOS","NOTA_PROTELEC","NCC_OCHO","VECES_L_TRES","VECES_PROTELEC",
              "CAR_OCHO","VECES_ADMIN","PROMEDIO_NUEVE"]
    },
    'electronica':{
        '1': ["CON_MAT_ICFES","QUIMICA_ICFES","PG_ICFES","FISICA_ICFES","IDIOMA_ICFES","BIOLOGIA_ICFES","GENERO","LOCALIDAD","LITERATURA_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO",
              "NOTA_DIF","EPA_UNO","NOTA_PROGB","NOTA_FIS_UNO","NCP_UNO","NOTA_TEXTOS","NOTA_CFJC","NAP_UNO","RENDIMIENTO_DOS","PROMEDIO_TRES"],
        
        '2': ["CON_MAT_ICFES","QUIMICA_ICFES","PG_ICFES","FISICA_ICFES","IDIOMA_ICFES","BIOLOGIA_ICFES","GENERO","LOCALIDAD","LITERATURA_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO",
              "NOTA_DIF","EPA_UNO","NOTA_PROGB","NOTA_FIS_UNO","NCP_UNO","NOTA_TEXTOS","NOTA_CFJC","NAP_UNO","RENDIMIENTO_DOS","RENDIMIENTO_TRES","PROMEDIO_DOS","NAA_DOS","NOTA_INT",
              "VECES_INT","NCA_DOS","NOTA_FIS_DOS","CAR_DOS","PROMEDIO_TRES","NCA_TRES","NOTA_FIS_TRES","NOTA_EL_UNO","VECES_FIS_TRES","NOTA_DEM","RENDIMIENTO_CUATRO","PROMEDIO_CINCO"],

        '3': ["CON_MAT_ICFES","QUIMICA_ICFES","PG_ICFES","FISICA_ICFES","IDIOMA_ICFES","BIOLOGIA_ICFES","GENERO","LOCALIDAD","LITERATURA_ICFES","RENDIMIENTO_UNO","PROMEDIO_UNO",
              "NOTA_DIF","EPA_UNO","NOTA_PROGB","NOTA_FIS_UNO","NCP_UNO","NOTA_TEXTOS","NOTA_CFJC","NAP_UNO","RENDIMIENTO_DOS","RENDIMIENTO_TRES","PROMEDIO_DOS","NAA_DOS","NOTA_INT",
              "VECES_INT","NCA_DOS","NOTA_FIS_DOS","CAR_DOS","PROMEDIO_TRES","NCA_TRES","NOTA_FIS_TRES","NOTA_EL_UNO","VECES_FIS_TRES","NOTA_DEM","RENDIMIENTO_CUATRO","RENDIMIENTO_CINCO",
              ...
              "NOTA_TFM","VECES_ADMICRO","NAC_CINCO","RENDIMIENTO_SEIS","PROMEDIO_SEIS","NOTA_COMANA","NOTA_MOYGE","NOTA_CCON","VECES_COMANA","VECES_DDM","NOTAS_SYS","RENDIMIENTO_SIETE",
              "PROMEDIO_SIETE","NOTA_SISDIN","NOTA_ELECPOT","NOTA_COMDIG","NOTA_FDS","NCC_SIETE","RENDIMIENTO_OCHO","PROMEDIO_OCHO","NOTA_STG","NOTA_C_UNO","NOTA_INSIND","NAP_OCHO","NOTA_INGECO","PROMEDIO_NUEVE"]
    }
}
