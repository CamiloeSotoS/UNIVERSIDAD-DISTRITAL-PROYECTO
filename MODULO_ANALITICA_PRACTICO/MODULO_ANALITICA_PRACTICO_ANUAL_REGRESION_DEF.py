...
variables_por_carrera = { 
    'industrial': {
        ...
        'LOCALIDAD','CAR_UNO','NCC_UNO','NAA_UNO','NOTA_DIFERENCIAL','NOTA_DIBUJO','NOTA_QUIMICA','NOTA_CFJC','NOTA_TEXTOS','NOTA_SEMINARIO','NOTA_EE_UNO','PROMEDIO_DOS','PROMEDIO_TRES'],
